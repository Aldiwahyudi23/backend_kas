    ...
    <div class="card card-primary card-outline">
        <div class="card-body box-profile">
            <div class="text-center">
                ...
                <a href="{{ asset($foto->first()->foto) }}" data-toggle="lightbox" data-title="Foto Profile {{ Auth::user()->name }}" data-gallery="gallery" data-footer=' <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <img src="{{ asset( $foto->first()->foto) }}" width="130px" class="profile-user-img img-fluid img-circle" alt="User profile picture">
                </a>
