                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    <a href="{{ asset($ayah->foto) }}" data-toggle="lightbox" data-title="Foto Profile {{ Auth::user()->name }}" data-gallery="gallery" data-footer=' <form action="{{ Route('data-warga.update', Crypt::encrypt($ayah->id)) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <img src="{{ asset( $ayah->foto) }}" width="130px" class="profile-user-img img-fluid img-circle" alt="User profile picture">
                                    </a>
                                </div>
