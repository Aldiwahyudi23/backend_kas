                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="number" id="no_hp" name="no_hp" value="{{ old('no_hp',$data_pribadi->no_hp) }}" placeholder="62 81xx xxxx xxxx" class="form-control col-12 @error('no_hp') is-invalid @enderror">
                                @error('no_hp')
                                <div class="invalid-feedback">
                                    <strong>{{ $message }}</strong>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="status" name="status" class="select2bs4 form-control @error('status') is-invalid @enderror">
                                    ...
                                    <option value="{{old('status',$data_pribadi->status)}}">{{old('status',$data_pribadi->status)}}</option>
                                    @endif
                                    <option value="">-- Pilih Status Pernikahan --</option>
