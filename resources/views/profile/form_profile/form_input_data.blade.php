<form action="{{Route('data-warga.store')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card card-primary card-outline card-outline-tabs">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select name="provinsi" id="provinsi3" class=" form-control col-12 @error('provinsi') is-invalid @enderror">
            ...
            <div class=" form-group">
                ...
                <select name="kota" id="kota3" class="form-control col-12 @error('kota') is-invalid @enderror">
                    <option value="">Pilih</option>
                </select>
                @error('kota')
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select name="kecamatan" id="kecamatan3" class="form-control col-12 @error('kecamatan') is-invalid @enderror">
                    <option value="">Pilih</option>
                </select>
                @error('kecamatan')
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select name="kelurahan" id="kelurahan3" class="form-control col-12 @error('kelurahan') is-invalid @enderror">
                    <option value="">Pilih</option>
                </select>
                @error('kelurahan')
                <div class="invalid-feedback">
    ...
    <div class="card card-primary card-outline card-outline-tabs">
        <div class="card-body">
            ...
            <input type="hidden" name="pribadi" id="pribadi" value="pribadi"> <!-- Umtuk membedakan input dari pribadi dan admin-->
